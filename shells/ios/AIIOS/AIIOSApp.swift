// The iOS shell: the runtime is the identity; this app
...
final class RuntimeHolder: ObservableObject {
    ...
    // it. Observed on the simulator, where a stale container
...
// TimeWakeScheduler is the Swift half of the OS-wake loop: Go's TIME hands over its ONE next-due moment (each schedule
