...
const auditOutputPlaybackPage = micMarkup + `<button id="hush-speaking" hidden></button><script type="module">
...
func TestAuditEarbudsPrimesPlaybackDuringTheFirstGesture(t *testing.T) {
	runPageInEngines(t, strings.ReplaceAll(auditOutputPlaybackPage, "__CASE__", "prime"), micModules)
}
